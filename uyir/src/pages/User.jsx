  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentSponsorIndex(
        (prevIndex) => (prevIndex + 1) % sponsorImages.length
      );
    }, 5000);
                    ...
                    {latestReports.length > 0 ? (
                      latestReports.map((report, index) => (
                        <tr
                          ...
                          className="text-black border-t border-white border-opacity-10"
                        >
          ...
          <div className="max-w-[385px] w-full lg:fixed lg:right-6 lg:top-32">
            ...
            >
              <div className="flex mb-2">
                ...
                <div className="w-1/2">
                  <span className="text-xl font-semibold text-[var(--primary-color)] text-right">
                    500
                  </span>
                  <p className="text-lg font-semibold text-orange-700 text-right">
                    Nanban
                  </p>
              ...
              <div className="absolute inset-x-0 bottom-4 h-12">
                <div className="relative w-full h-full">
                  ...
                  {/* Vehicles */}
                  <span className="absolute bottom-2 text-2xl animate-car">
                    🚗
                  </span>
                  <span
                    className="absolute bottom-2 text-2xl animate-motorcycle"
                    style={{ animationDelay: "1s" }}
                  >
                    🏍
                  </span>
                  <span
                    className="absolute bottom-0.5 text-2xl animate-truck"
